...
export const ModeToggle = () => {
    ...
    const SWITCH = () => {
        switch (theme) {
            ...
            case "dark":
                ...
                return;
            case "system":
                setTheme(systemTheme === "dark" ? "light" : "dark"); return;
            default:
                setTheme("light");
                return;
        }
    ...
    return (
        ...
        >
            ...
            <Moon size={14} className="rotate-90 absolute inset-0 scale-0 transition-all duration-200 dark:rotate-0 dark:scale-100" />
        </button>
    );
};